...
struct arguments input_args = {"", "a.out", false, false, true, false, false};

// The options we understand
static struct argp_option options[] = {
    {"scan", 's', 0, 0, "Validates that the file passes scanning", 0},
    {"parse", 'p', 0, 0, "TODO: write documentation here", 0},
    {"format", 'f', 0, 0, "Outputs a formatted version of the input source", 0},
    {"graph", 'g', 0, 0, "Outputs a Graphviz .dot file of the AST of the input source", 0},
